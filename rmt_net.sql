...
--
-- Host: localhost
-- Generation Time: Nov 09, 2023 at 02:30 PM
...
-- Database: `rmt_net`
--
CREATE DATABASE IF NOT EXISTS `rmt_net` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `rmt_net`;
...
('abfhxi3prhm37evc1uynoozcvzvyudjj', 'eyJ1c2VyaWQiOjJ9:1qgmLA:D68oLUT66lVI42YXaD00FP9qUKCvVTUZkpHC_kPzGrs', '2023-09-28 13:25:04.525442'),
...
('h4xcjhxl4cep2ax35vni1vbv4r111nn8', 'eyJ1c2VyaWQiOjJ9:1oVWVV:YMStMUaRnDa_HSjAzTpNAQtRUAcGjoke7gU2jplnm18', '2022-09-20 11:12:41.660480'),
...
('i0kvljn4re60booxpgzg05zruq3c2zg2', 'eyJ1c2VyaWQiOjF9:1qpp4f:u9RRAvEB0dTWfHgC94wBcK0GetDVubuG9afO2-3lGZc', '2023-10-23 12:09:25.764586'),
...
('j6j7ok3lk2oloqdc705htqgdgk47kbve', 'eyJ1c2VyaWQiOjF9:1qKHel:ZsVKtQlleBZ4z6eKat8T3yfVSdQiO2KdQeuTCep3D6Q', '2023-07-28 12:12:19.401917'),
...
('p8kh6t62szozizpeckqyqx2v1vv08yby', 'eyJ1c2VyaWQiOjJ9:1qppqa:llmMh7L43qZ6M2M0AcovXBTSFGB-Sz4rbFvuf14pc-w', '2023-10-23 12:58:56.089806'),
...
('v4cy6v9p9dc35s14kqn765efu9qeuzmt', 'eyJ1c2VyaWQiOjF9:1oVVox:3fgwzprLgBScINA_UGq2gv8XW36PJDKFkAPwJoS4g_I', '2022-09-20 10:28:43.516420'),
('vpls6gucgk3uvgm28zo7lodfezj1qjmc', 'eyJ1c2VyaWQiOjF9:1qKFll:Url3a0cXqfu5hWemD4wka-g7TBCDC5NSoJKt3_OfJ84', '2023-07-28 10:11:25.394400'),
...
--
-- Table structure for table `remote_user_credit_scoring_detection`
--

CREATE TABLE IF NOT EXISTS `remote_user_credit_scoring_detection` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `Customer_Id` varchar(300) NOT NULL,
  `Name` varchar(300) NOT NULL,
  `Age` varchar(300) NOT NULL,
  `Occupation` varchar(300) NOT NULL,
  `Annual_Income` varchar(300) NOT NULL,
  `Monthly_Inhand_Salary` varchar(300) NOT NULL,
  `Num_Bank_Accounts` varchar(300) NOT NULL,
  `Num_Credit_Card` varchar(300) NOT NULL,
  `Interest_Rate` varchar(300) NOT NULL,
  `Num_of_Loan` varchar(300) NOT NULL,
  `Type_of_Loan` varchar(300) NOT NULL,
  `Delay_from_due_date` varchar(300) NOT NULL,
  `Num_of_Delayed_Payment` varchar(300) NOT NULL,
  `Changed_Credit_Limit` varchar(300) NOT NULL,
  `Num_Credit_Inquiries` varchar(300) NOT NULL,
  `Credit_Mix` varchar(300) NOT NULL,
  `Outstanding_Debt` varchar(300) NOT NULL,
  `Credit_Utilization_Ratio` varchar(300) NOT NULL,
  `Credit_History_Age` varchar(300) NOT NULL,
  `Payment_of_Min_Amount` varchar(300) NOT NULL,
  `Total_EMI_per_month` varchar(300) NOT NULL,
  `Amount_invested_monthly` varchar(300) NOT NULL,
  `Payment_Behaviour` varchar(300) NOT NULL,
  `Monthly_Balance` varchar(300) NOT NULL,
  `Prediction` varchar(300) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=4 ;

--
-- Dumping data for table `remote_user_credit_scoring_detection`
--

INSERT INTO `remote_user_credit_scoring_detection` (`id`, `Customer_Id`, `Name`, `Age`, `Occupation`, `Annual_Income`, `Monthly_Inhand_Salary`, `Num_Bank_Accounts`, `Num_Credit_Card`, `Interest_Rate`, `Num_of_Loan`, `Type_of_Loan`, `Delay_from_due_date`, `Num_of_Delayed_Payment`, `Changed_Credit_Limit`, `Num_Credit_Inquiries`, `Credit_Mix`, `Outstanding_Debt`, `Credit_Utilization_Ratio`, `Credit_History_Age`, `Payment_of_Min_Amount`, `Total_EMI_per_month`, `Amount_invested_monthly`, `Payment_Behaviour`, `Monthly_Balance`, `Prediction`) VALUES
(1, '10.42.0.151-111.206.25.159-43643-80-6', 'Rick Rothackerj', '28', 'Teacher', '34847.84', '3037.986667', '2', '4', '6', '1', 'Credit-Builder Loan', '3', '0', '5.42', '2', 'Good', '605.03', '33.3810102', '27 Years and 0 Months', 'No', '18.81621457', '43.47719014', 'High_spent_Large_value_payments', '481.5052619', 'Poor'),
(2, '10.42.0.211-10.42.0.1-16360-53-17', 'Josheh', '34', 'Engineer', '143162.64', '12187.22', '1', '5', '8', '3', 'Auto Loan, Auto Loan, and Not Specified', '13', '6', '7.1', '3', 'Good', '1303.01', '41.70257342', '17 Years and 10 Months', 'No', '246.9923195', '232.8603838', 'High_spent_Small_value_payments', '998.8692968', 'Good'),
(3, '10.42.0.1-10.42.0.42-5351-43736-17', 'Saphirj', '40', 'Teacher', '33751.27', '2948.605833', '5', '5', '20', '3', 'Credit-Builder Loan, Personal Loan, and Auto Loan', '17', '22', '11', '8', 'Standard', '1328.93', '23.40441278', '19 Years and 5 Months', 'Yes', '65.00817429', '25.19256191', 'High_spent_Large_value_payments', '444.6598471', 'Poor');
...
(8, 'Good', '33.33333333333333'),
(9, 'Poor', '66.66666666666666');
